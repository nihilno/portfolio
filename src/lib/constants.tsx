...
export const projects = [
...

  {
    ...
    description:
      "Full‑stack SPA invoice management platform (CRUD). Done with React/Vite + Node/Express. Beautifully designed. Includes authentication, routes protections and data from my own API, linked using CORS.",
    image: "/projects/lexa.png",
    tags: [
      "React + Vite",
      "React Router",
      "Node.js + Express 5",
    ...
    link: "https://lexa-wine.vercel.app/",
