...
function HeroContent() {
  return (
    <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
      <div className="gird-cols-1 grid items-center gap-12 lg:grid-cols-2">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-lg text-lg">
              ...
              Doloribus, ullam vero. Rem unde voluptates laudantium molestias
              tenetur illum iusto deleniti reprehenderit quam dolore, magni
              libero.
            </p>
          </div>
